...
{
   /// <summary>
   /// Well-known header names when communicating with PrivacyGate API over HTTP.
   /// </summary>
   public static class HeaderNames
   {
      /// <summary>
      /// Every PrivacyGate webhook request includes an X-CC-Webhook-Signature header.
      ...
      /// You can create an API key in your Settings page after creating a PrivacyGate account
