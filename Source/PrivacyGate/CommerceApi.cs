...
{
   /// <summary>
   /// The main class to use when accessing the PrivacyGate API. API Docs: https://privacygate.io/docs/api/
   /// </summary>
   public class CommerceApi
   {
      ...
      /// </summary>
      protected internal const string Endpoint = "https://api.privacygate.io";
      ...
      /// For more on unresolved charges, check out at <see href="https://privacygate.io/docs/api/#charge-timeline">Charge timeline</see>
      /// </summary>
      /// <param name="chargeCode">The Charge.Code</param>
      /// <returns></returns>
      ...
      /// on unresolved charges, check out at Charge timeline: https://privacygate.io/docs/api/#charge-timeline
      /// </summary>
      /// <param name="codeOrId">Invoice code or id</param>
