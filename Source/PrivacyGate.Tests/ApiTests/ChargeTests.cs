...
using PrivacyGate.Models;
using FluentAssertions;
using Newtonsoft.Json.Linq;
using NUnit.Framework;

namespace PrivacyGate.Tests.ApiTests
{
   public class ChargeTests : CommerceApiTests
   {
      ...
      public async Task can_list_charges()
      {
         ...
         server.ShouldHaveCalled("https://api.privacygate.io/charges")
      ...
      public async Task list_charges_with_different_ordering()
      {
         ...
         server.ShouldHaveCalled("https://api.privacygate.io/charges?order=asc&limit=75&starting_after=ffff&ending_before=gggg")
            .WithVerb(HttpMethod.Get);
      }
      ...
      public async Task can_get_a_single_charge()
      {
         ...
         server.ShouldHaveCalled("https://api.privacygate.io/charges/66BEOV2A")
            .WithVerb(HttpMethod.Get);
      }
      ...
      public async Task can_cancel_a_charge()
      {
         ...
         server.ShouldHaveCalled($"https://api.privacygate.io/charges/66BEOV2A/cancel")
            .WithVerb(HttpMethod.Post)
            .WithRequestBody("");
      }
      ...
      public async Task can_resolve_a_charge()
      {
         ...
         server.ShouldHaveCalled($"https://api.privacygate.io/charges/66BEOV2A/resolve")
            .WithVerb(HttpMethod.Post)
            .WithRequestBody("");
      }
   }
