...
namespace PrivacyGate.Tests.ApiTests
{
   public class CheckoutTests : CommerceApiTests
   {
      ...
      public async Task can_list_checkouts()
      {
         ...
         server.ShouldHaveCalled("https://api.privacygate.io/checkouts")
      ...
      public async Task list_checkouts_with_different_ordering()
      {
         ...
         server.ShouldHaveCalled("https://api.privacygate.io/checkouts?order=asc&limit=75&starting_after=ffff&ending_before=gggg")
            .WithVerb(HttpMethod.Get);
      }
      ...
      public async Task can_get_a_single_checkout()
      {
         ...
         server.ShouldHaveCalled("https://api.privacygate.io/checkouts/30934862-d980-46cb-9402-43c81b0cabd5")
            .WithVerb(HttpMethod.Get);
      }
      ...
      public async Task can_update_a_checkout()
      {
         ...
         server.ShouldHaveCalled($"https://api.privacygate.io/checkouts/{CheckoutData.CheckoutModel.Id}")
